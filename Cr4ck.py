...
def menu():
    ...
    print("\033[1;96m"+50*"-")
    print("\n%s [%s01%s] %s\033[1;36mCRACK DARI AKUN TUMBAL "%(p,b,p))
    print("%s [%s02%s] %s\033[1;36mCRACK ID DARI PUBLIK "%(p,b,p))
    print("%s [%s03%s] %s\033[1;36mCRACK ID DARI FOLOWERS "%(p,b,p))
    print("%s [%s04%s] %s\033[1;36mCRACK ID DARI POSTINGAN"%(p,b,p))
    print("%s [%s05%s] %s\033[1;36mCRACK ID MASALL/BRUTAL"%(p,b,p))
    print("%s [%s06%s] %s\033[1;36mCHECK OPSI SESI/CP"%(p,b,p))
    print("%s [%s07%s] %s\033[1;36mSETINGS USER AGENT"%(p,b,p))
    print("%s [%s99%s] %s\033[1;36mCHECK HASIL CRACK"%(p,b,p))
    print("%s [%s00%s] %s\033[1;31mHAPUS TOKEN/COKIES"%(p,b,p))
